...
- 처치/치료/수술/입원/항암/약제비 같은 담보는 **unmatched_coverages 로** 보내세요 (case 생성 X).
  - 예: "암수술비", "암입원일당", "표적항암치료비", "조혈모세포이식수술비", "항암약물치료비",
        "암직접치료입원비", "뇌혈관수술비", "심혈관질환수술비" → unmatched 처리.
...
진단비 -> 암 -> 일반암
  ...
  **제외 (case 생성 X)**: 암수술, 암수술비, 항암방사선, 항암약물, 항암치료, 암입원, 암직접치료, 암직접치료입원, 표적항암, 면역항암, 조혈모세포이식수술, 조혈모세포, 다발성소아암수술 — 이건 처치·치료성 담보. 진단비 버킷에 합산하면 그래프가 부풀려짐.
