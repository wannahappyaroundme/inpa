...
class NormalizationAccuracySerializer(serializers.Serializer):
    ...
    exact_auto_mapped = serializers.IntegerField()
    safe_human_review = serializers.IntegerField()
    unsafe_auto_mapped = serializers.IntegerField()
    safe_decision_rate = serializers.FloatField()
    evaluation_scope = serializers.CharField()
    evaluation_scope_note = serializers.CharField()
