...
from .views import (
    ...
    AdminBlogLegalReviewView,
    AdminBlogPostListView,
    AdminBillingAgreementListView,
    AdminBillingCouponDetailView,
    AdminBillingCouponListView,
    AdminBillingOrderListView,
    AdminBillingOrderReconcileView,
    AdminBillingOverviewView,
    AdminBillingSettingsView,
    AdminBillingTokenRevokeView,
    AdminClaudeCostView,
    AdminConsultationComparisonView,
...
urlpatterns = [
    ...
    path('admin/consultations/', AdminConsultationSettingsView.as_view(),
         name='admin-consultation-settings'),
    path('admin/consultations/comparison/',
         AdminConsultationComparisonView.as_view(),
         name='admin-consultation-comparison'),
    path('admin/consultations/pilot-users/',
         AdminConsultationPilotListView.as_view(),
         name='admin-consultation-pilot-list'),
    ...
    path('admin/billing/overview/',
         AdminBillingOverviewView.as_view(),
         name='admin-billing-overview'),
    path('admin/billing/coupons/',
         AdminBillingCouponListView.as_view(),
         name='admin-billing-coupon-list'),
    path('admin/billing/coupons/<int:coupon_id>/',
         AdminBillingCouponDetailView.as_view(),
         name='admin-billing-coupon-detail'),
    path('admin/billing/agreements/',
         AdminBillingAgreementListView.as_view(),
         name='admin-billing-agreement-list'),
    path('admin/billing/orders/',
         AdminBillingOrderListView.as_view(),
         name='admin-billing-order-list'),
    path('admin/billing/orders/<int:order_id>/reconcile/',
         AdminBillingOrderReconcileView.as_view(),
         name='admin-billing-order-reconcile'),
    path('admin/billing/tokens/<int:token_id>/revoke/',
         AdminBillingTokenRevokeView.as_view(),
         name='admin-billing-token-revoke'),
    path('admin/billing/settings/',
         AdminBillingSettingsView.as_view(),
    ...
    path('admin/normalization/accuracy/', AdminNormalizationAccuracyView.as_view(),
         name='admin-normalization-accuracy'),
    ...
    path('admin/blog/<int:post_id>/legal-review/', AdminBlogLegalReviewView.as_view(),
         name='admin-blog-legal-review'),
