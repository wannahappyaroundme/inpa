...
class NotifType(models.TextChoices):
    ...
    # ── 경력 설계사 영입 — 지원·후속 연락·정착·첫 관리자 활성화. ──
    ...
    MANAGER_PROMOTED = 'manager_promoted', '관리자 기능 활성화'
...
RECRUITING_NOTIF_TYPES = frozenset({
    NotifType.RECRUITING_APPLICATION.value,
    NotifType.RECRUITING_FOLLOWUP.value,
    NotifType.RECRUITING_SETTLEMENT.value,
    NotifType.MANAGER_PROMOTED.value,
})
