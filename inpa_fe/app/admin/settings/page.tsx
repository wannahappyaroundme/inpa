                ...
                {editingPlan?.code === p.code ? (
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {(["limit_ocr", "limit_ai_compare", "limit_analysis", "limit_promotion", "limit_customer", "limit_consultation_summary", "limit_consultation_minute"] as const).map((field) => (
                        <div key={field}>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-[12px] text-ink3">
                        OCR {p.limit_ocr ?? "∞"} · AI비교 {p.limit_ai_compare ?? "∞"} · 분석 {p.limit_analysis ?? "∞"} · 고객추가 {p.limit_customer ?? "∞"} · 판촉 {p.limit_promotion ?? "∞"} · 상담요약 {p.limit_consultation_summary ?? "∞"}회 · 음성처리 {p.limit_consultation_minute ?? "∞"}분
                      </div>
                    </div>
                    <button
